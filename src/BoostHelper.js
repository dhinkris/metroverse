                ...
                <Box gridColumn="span 8">
                    <div style={{ display: 'flex' }}>
                        <div style={{ flexGrow: 1 }}>
                            <h5 style={{marginTop: "60px"}}> Disclaimer: This search feature is based on block info from 20000 to 62019. More info will be update hopefully by end of the day.
                            <br/><br/>
